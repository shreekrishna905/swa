...
public class ESBApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		restTemplate.postForLocation("http://localhost:8080/orders", new Order("334", 120.0,OrderType.DOMESTIC));
		restTemplate.postForLocation("http://localhost:8080/orders", new Order("336", 120.0, OrderType.INTERNATIONAL));
